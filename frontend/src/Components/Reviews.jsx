...
const Reviews = () => {
  // State for review text and name inputs
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle submission logic here, e.g., send the review to the server
  ...
  return (
    <div className="mt-4 ml-3">
          ...
          <div className="p-5">
            ...
            <div>
              <p className="flex gap-2">
                <ImQuotesLeft />It looks Good, I liked it.<ImQuotesRight />
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="px-3">
        <div className="mb-5">
          <h1 className="text-2xl font-bold mb-2">Add A Review</h1>
          <p className="text-slate-400 mb-2">Please add your valuable review.</p>
        </div>

        <div className="mt-1 lg:p-4 mb-2">
          <div>
            <h3 className="text-xl font-bold mb-2">Your Rating<sup>*</sup></h3>
            <div className="flex mb-4">
              <AiFillStar className="text-red-500 cursor-pointer" />
              <AiFillStar className="text-red-500 cursor-pointer" />
              <AiFillStar className="text-red-500 cursor-pointer" />
              <AiFillStar className="text-red-500 cursor-pointer" />
              <AiOutlineStar />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="review" className="block text-gray-700 font-semibold">
                Review<sup>*</sup>
              </label>
              <textarea
                id="review"
