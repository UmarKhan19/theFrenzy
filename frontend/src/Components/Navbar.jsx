...
const Navbar = () => {
  ...
  return (
    <header className="w-11/12 absolute z-10 p-3">
      <nav className="flex justify-between bg-transparent p-4 pl-0 max-md:pl-0 items-center">
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="fixed left-0 top-0 h-full bg-white w-64 z-50 p-4 shadow-md">
            <div className="flex justify-end">
              <HiMenu className="cursor-pointer" onClick={toggleMenu} />
            </div>
            ...
            <div className="flex flex-col gap-4 mb-4">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="font-montserrat text-lg">Sakshat</span>
              </div>
        ...
        {/* Right section of the navbar for small screens */}
        ...
        {/* Right section of the navbar for large screens */}

        <div className="flex justify-between items-center gap-4">
          {/* Search input (you can uncomment this if needed) */}
          {/* <div>
            <input
              type="text"
              placeholder="Search your Product"
              className="p-1 rounded-full pl-5 max-md:hidden border-2 border-black"
            />
          </div> */}

          {/* Icons for heart and shopping bag */}
          <div className="flex gap-6  items-center">
            <div className="flex gap-6 items-center">
              <Link to="/wishlist">
              <AiOutlineHeart className="text-2xl cursor-pointer hover:text-red-600" />
              </Link>
              <Link to="/Cart">
              <PiShoppingBag className="text-2xl cursor-pointer hover:text-blue-600" />
              </Link>
            </div>
            <div>
              <Link to="/Profile">
