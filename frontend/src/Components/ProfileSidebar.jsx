...
const ProfileSidebar = () => {
    ...
    const listItems = list.map((item, index) => (
        <div key={index} className='border-2 px-5 py-3 cursor-pointer'>
          {item.link}
        </div>
      ));
  ...
  return (
    <div>
      ...
      <div className='border-2 bg-gray-400  px-5 py-3 mb-4'>
        ...
        <a href="#" className='text-red-600 underline text-sm'>Get Membership Now</a>
      </div>

      <hr />

      <div className='flex justify-between border-2 px-5 py-3 mb-4 cursor-pointer'>
        <h3>Orders</h3>
