...
const MyCard = ({ cardData }) => {
  ...
  // axios.get("http://localhost:5001/api/product/hot-products").then(res=>console.log(res.data.hotProducts)).catch(res=>console.log(res))
  ...
  return (
    <div className='bg-white mr-4 border-b-2 shadow-md'>
    <div className="bg-white  shadow-md">
    <Link to="/single-product">
      <img
        src={cardData.img}
        alt={cardData.title}
        className="w-full h-80 max-sm:h-60 cursor-pointer shadow-lg object-cover"
        />
    </Link>
    <div className="p-4">
