...
const CartProd = () => {
  ...
  return (
    <div className='border-y-2 md:w-3/5'>
    <div className='flex items-start flex-wrap justify-between m-3'>
      ...
      <div>
        ...
        <div className=''>
        <h2 className='font-semibold'>Round Neck & Printed T-shirt</h2>
        <p className=''>Color: Olive</p>
        <p className=''>Size: S</p>
        <p className=''>In Stock</p>

        <div className='mt-5 flex lg:gap-8'>
        <button className='flex items-center border-2 p-2 hover:bg-gray-500 hover:text-white'><MdOutlineDeleteForever className='text-2xl'/>Remove</button>
